...
(1, 1, 1, 'Khám', '2026-04-20', 'Khám tổng quát định kỳ cho Mochi.', 'Sức khỏe ổn định, cân nặng đạt chuẩn, không có dấu hiệu bất thường.'),
(1, 2, 2, 'Vaccine', '2026-04-22', 'Tiêm phòng dại cho Pudding.', 'Đã tiêm 1 mũi Rabisin, theo dõi 30 phút sau tiêm, phản ứng tốt.'),
(2, 3, 3, 'Điều trị', '2026-04-18', 'Điều trị viêm da dị ứng cho Mimi.', 'Bôi thuốc kháng viêm trong 7 ngày, tránh thức ăn có hải sản.'),
(3, 4, 4, 'Khám', '2026-04-25', 'Khám lần đầu cho Max.', 'Cún khỏe mạnh, đề nghị tiêm phòng vaccine 7 bệnh.'),
(4, 5, 5, 'Điều trị', '2026-04-16', 'Điều trị viêm tai cho Luna.', 'Làm sạch tai, kê thuốc nhỏ tai và kháng sinh uống 5 ngày.'),
(5, 6, 2, 'Vaccine', '2026-04-15', 'Tiêm phòng 4 bệnh cho Kitty.', 'Đã tiêm FVRCP, không có phản ứng phụ.'),
(6, 8, 1, 'Khám', '2026-04-16', 'Khám sức khỏe cho Snowball.', 'Ổn định, cân nặng 5.2kg, mắt trong.'),
(7, 9, 2, 'Vaccine', '2026-04-17', 'Tiêm phòng 7 bệnh cho Rocky.', 'Tiêm DHPPiL, theo dõi tốt.'),
(8, 10, 5, 'Điều trị', '2026-04-17', 'Điều trị rối loạn tiêu hóa cho Chloe.', 'Kê thuốc men tiêu hóa 5 ngày, ăn cháo loãng.'),
(9, 11, 4, 'Khám', '2026-04-19', 'Khám tổng quát cho Cooper.', 'Sức khỏe tốt, đề xuất tẩy giun định kỳ.'),
(10, 12, 3, 'Điều trị', '2026-04-16', 'Viêm da nhẹ ở tai phải Bella.', 'Bôi thuốc hằng ngày, kiểm tra lại sau 1 tuần.'),
(11, 13, 1, 'Khám', '2026-04-21', 'Khám định kỳ cho Charlie.', 'Đề xuất tiêm phòng dại.'),
(12, 14, 4, 'Vaccine', '2026-04-22', 'Tiêm phòng dại cho Tom.', 'Tiêm Rabisin, theo dõi tốt.'),
(13, 15, 5, 'Điều trị', '2026-04-24', 'Điều trị nấm ngoài da cho Nala.', 'Tắm bằng dung dịch đặc trị, 3 lần/tuần.'),
(14, 16, 6, 'Khám', '2026-04-26', 'Khám kiểm tra sau điều trị Duke.', 'Tình trạng da đã cải thiện 95%.'),
(15, 17, 7, 'Vaccine', '2026-04-27', 'Tiêm phòng 7 bệnh cho Buddy.', 'Không phản ứng phụ, sức khỏe tốt.'),
(16, 18, 1, 'Điều trị', '2026-04-17', 'Điều trị cảm lạnh cho Sophie.', 'Giữ ấm, vitamin C và kháng sinh 3 ngày.'),
(17, 19, 8, 'Khám', '2026-04-19', 'Khám sức khỏe tổng quát Teddy.', 'Ổn định, cân nặng đạt chuẩn giống Pomeranian.'),
(18, 20, 2, 'Điều trị', '2026-04-21', 'Điều trị stress do xa chủ cho Daisy.', 'Bổ sung vitamin, tạo môi trường thoải mái.'),
(19, 3, 3, 'Vaccine', '2026-04-25', 'Tiêm vaccine 4 bệnh mèo cho Mimi.', 'Hoàn tất FVRCP, theo dõi tốt.'),
(1, 1, 1, 'Khám', '2026-04-30', 'Khám định kỳ tháng 1 cho Mochi.', 'Sức khỏe tốt, cân nặng ổn định.'),
(2, 3, 2, 'Vaccine', '2026-04-30', 'Tiêm nhắc vaccine dại cho Mimi.', 'Đã tiêm Rabisin, phản ứng tốt.'),
(3, 4, 4, 'Khám', '2026-04-30', 'Khám kiểm tra sức khỏe Max.', 'Cún khỏe, đề xuất tẩy giun.'),
(4, 5, 5, 'Điều trị', '2026-04-30', 'Kiểm tra tai Luna sau điều trị.', 'Tai đã lành, ngừng thuốc.');

-- === VACCINATION RECORDS ===
INSERT INTO vaccination_records (medical_record_id, vaccine_name, batch_number, next_injection_date) VALUES
(2, 'Rabisin (Phòng dại)', 'RBS-2026-04', '2027-01-22'),
(6, 'FVRCP (Phòng 4 bệnh mèo)', 'FVR-2026-04', '2027-01-15'),
(8, 'DHPPiL (Phòng 7 bệnh)', 'DHP-2026-04', '2027-01-17'),
(13, 'Rabisin (Phòng dại)', 'RBS-2026-04B', '2027-01-22'),
(16, 'DHPPiL (Phòng 7 bệnh)', 'DHP-2026-04', '2027-01-27'),
(20, 'FVRCP (Phòng 4 bệnh mèo)', 'FVR-2026-04B', '2027-01-25'),
(22, 'Rabisin (Phòng dại)', 'RBS-2026-04C', '2027-01-30');
...
(1, 1, 101, '2026-04-18 09:00:00', '2026-04-21 10:00:00', 80000, 100000, 500000, 'Gửi 3 ngày, thú cưng ngoan, ăn uống tốt.', 'Check Out'),
(2, 3, 102, '2026-04-20 08:30:00', '2026-04-25 09:00:00', 100000, 150000, 1000000, 'Mèo VIP, chuồng có điều hòa, camera.', 'Check Out'),
(3, 4, 103, '2026-04-26 10:00:00', NULL, 85000, 120000, 800000, 'Cún lần đầu gửi, cần quan sát kỹ.', 'Check In'),
(4, 5, 104, '2026-04-22 14:00:00', '2026-04-26 09:00:00', 90000, 100000, 600000, 'Thú cưng sợ tiếng ồn, đặt phòng yên tĩnh.', 'Check Out'),
(5, 6, 105, '2026-04-28 09:00:00', NULL, 95000, 130000, 700000, 'Mèo đang theo dõi sức khỏe.', 'Check In'),
(6, 8, 106, '2026-04-15 08:00:00', '2026-04-18 10:00:00', 80000, 100000, 500000, 'Gửi 3 ngày.', 'Check Out'),
(7, 9, 107, '2026-04-16 09:00:00', '2026-04-20 11:00:00', 120000, 200000, 1000000, 'Chó lớn, cần phòng rộng.', 'Check Out'),
(8, 10, 108, '2026-04-17 08:30:00', '2026-04-20 09:00:00', 85000, 100000, 600000, 'Có camera theo dõi 24/7.', 'Check Out'),
(9, 11, 109, '2026-04-19 09:00:00', '2026-04-22 09:00:00', 110000, 150000, 800000, 'Chó Golden, cần nhiều không gian.', 'Check Out'),
(10, 12, 110, '2026-04-20 10:00:00', '2026-04-23 10:00:00', 90000, 120000, 600000, 'Mèo lông dài, chải lông mỗi ngày.', 'Check Out'),
(11, 13, 111, '2026-04-22 09:00:00', NULL, 85000, 100000, 500000, 'Đang điều trị ve, cần theo dõi.', 'Check In'),
(12, 14, 112, '2026-04-22 08:00:00', '2026-04-25 09:00:00', 80000, 100000, 400000, 'Mèo nhỏ, rất ngoan.', 'Check Out'),
(13, 15, 113, '2026-04-24 10:00:00', '2026-04-28 09:00:00', 85000, 110000, 500000, 'Mèo mới, cần quan sát.', 'Check Out'),
(14, 16, 114, '2026-04-26 09:00:00', '2026-04-29 09:00:00', 115000, 180000, 900000, 'Chó Becgie, cần phòng riêng.', 'Check Out'),
(15, 17, 115, '2026-04-27 09:30:00', NULL, 110000, 160000, 800000, 'Đang gửi dài hạn.', 'Check In'),
(16, 18, 116, '2026-04-17 08:00:00', '2026-04-20 09:00:00', 100000, 120000, 600000, 'Mèo không lông, cần giữ ấm.', 'Check Out'),
(17, 19, 117, '2026-04-19 08:30:00', '2026-04-22 09:00:00', 75000, 80000, 400000, 'Chó nhỏ, hay sủa ban đêm.', 'Check Out'),
(18, 20, 118, '2026-04-21 08:00:00', '2026-04-24 09:00:00', 75000, 80000, 400000, 'Chó nhút nhát, cần nhẹ nhàng.', 'Check Out'),
(19, 4, 119, '2026-04-28 10:00:00', NULL, 85000, 120000, 700000, 'Gửi trong khi chủ đi du lịch.', 'Check In'),
(20, 6, 120, '2026-04-27 09:00:00', NULL, 95000, 130000, 700000, 'Mèo VIP, có yêu cầu đặc biệt.', 'Check In'),
(1, 2, 121, '2026-04-30 08:00:00', '2026-04-30 10:00:00', 80000, 100000, 500000, 'Gửi 1 đêm, Pudding khám vaccine.', 'Check Out'),
(2, 3, 122, '2026-04-30 09:00:00', NULL, 100000, 150000, 800000, 'Mimi gửi từ 31/1, đang Check In.', 'Check In');
...
(1, 1, 1, NULL, '2026-04-21 11:00:00', 0, 340000, 100000, 240000),
(2, 3, 2, NULL, '2026-04-25 10:30:00', 50000, 650000, 150000, 450000),
(4, 5, 4, NULL, '2026-04-26 09:30:00', 0, 460000, 100000, 360000),
(6, 8, 6, NULL, '2026-04-18 11:00:00', 0, 340000, 100000, 240000),
(7, 9, 7, NULL, '2026-04-20 11:30:00', 100000, 680000, 200000, 380000),
(8, 10, 8, NULL, '2026-04-20 10:00:00', 0, 355000, 100000, 255000),
(9, 11, 9, NULL, '2026-04-22 09:30:00', 0, 530000, 150000, 380000),
(10, 12, 10, NULL, '2026-04-23 09:45:00', 0, 370000, 120000, 250000),
(12, 14, 12, NULL, '2026-04-25 09:15:00', 0, 340000, 100000, 240000),
(13, 15, 13, NULL, '2026-04-28 10:30:00', 30000, 440000, 110000, 300000),
(14, 16, 14, NULL, '2026-04-29 09:40:00', 0, 545000, 180000, 365000),
(16, 18, 16, NULL, '2026-04-20 09:00:00', 0, 400000, 120000, 280000),
(17, 19, 17, NULL, '2026-04-22 09:00:00', 0, 325000, 80000, 245000),
(18, 20, 18, NULL, '2026-04-24 09:00:00', 0, 325000, 80000, 245000),
(1, 2, 21, NULL, '2026-04-30 10:30:00', 0, 330000, 100000, 230000);
...
(1, 1, 1, 1, 1, '2026-04-20', '2027-01-20', 'Tiêm phòng dại định kỳ hàng năm.'),
(2, 2, 1, 2, 2, '2026-04-22', '2027-01-22', 'Tiêm 7 bệnh lần đầu.'),
(5, 6, 2, 3, 1, '2026-04-15', NULL, 'Tiêm FVRCP cho mèo, theo dõi phản ứng.'),
(4, 4, 3, 4, 3, '2026-04-25', '2026-02-25', 'Tiêm Parvo mũi tăng cường.');

-- === TREATMENT COURSES ===
INSERT INTO treatment_courses (medical_record_id, customer_id, pet_id, start_date, end_date, status) VALUES
(3, 2, 3, '2026-04-18', NULL, '1'),
(4, 4, 5, '2026-04-16', '2026-04-23', '0'),
(NULL, 5, 7, '2026-04-25', NULL, '1');
...
(1, 3, '2026-04-19 09:00:00', 38.8, 4.2, 95, 28, 'Mèo sốt nhẹ do viêm da, bắt đầu điều trị.'),
(1, 3, '2026-04-22 09:30:00', 38.2, 4.3, 88, 24, 'Đã giảm sốt, da đang lành.'),
(2, 5, '2026-04-17 10:00:00', 39.2, 8.8, 100, 32, 'Viêm tai nặng, cần điều trị tích cực.'),
(2, 5, '2026-04-21 10:00:00', 38.5, 8.9, 92, 26, 'Cải thiện rõ rệt, tiếp tục thuốc.'),
(3, 4, '2026-04-26 08:45:00', 37.5, 7.8, 85, 22, 'Khám định kỳ, béo phì nhẹ.');
